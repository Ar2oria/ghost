...
import cc.w0rm.ghost.mysql.po.EmailExample.Criteria;
import cc.w0rm.ghost.mysql.po.EmailExample.Criterion;
...
public class EmailSqlProvider {
    ...
    public String countByExample(EmailExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(EmailExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("email");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Email record = (Email) parameter.get("record");
    ...
    protected void applyWhere(SQL sql, EmailExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
